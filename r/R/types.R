...
Thing <- function(
  ...
  self[["description"]] <- check_property("Thing", "description", FALSE, missing(description), Union(Array(Union(BlockContent, InlineContent)), "character"), description)
...
CreativeWork <- function(
  ...
  self[["content"]] <- check_property("CreativeWork", "content", FALSE, missing(content), Union(Array(Union(BlockContent, InlineContent)), "character"), content)
...
#' @param id The identifier for this item.
#' @param meta Metadata associated with this item.
#' @return A `list` of class `Validator`
#' @seealso \code{\link{Entity}}
#' @export
Validator <- function(
  id,
  ...
  self$type <- as_scalar("Validator")

  class(self) <- c(class(self), "Validator")
  self
}
...
ListItem <- function(
  ...
  self[["content"]] <- check_property("ListItem", "content", FALSE, missing(content), Array(Union(BlockContent, InlineContent)), content)
...
TableCell <- function(
  ...
  self[["content"]] <- check_property("TableCell", "content", FALSE, missing(content), Array(Union(BlockContent, InlineContent)), content)
