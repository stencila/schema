...
#'
#' @name CodeError
#' @param message The error message or brief description of the error. \bold{Required}.
...
CodeError <- function(
  ...
  self[["message"]] <- check_property("CodeError", "message", TRUE, missing(message), "character", message)
